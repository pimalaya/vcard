...
//! nodes in the sibling modules ([`line`](crate::v2_1::tree::line),
//! [`param`](crate::v2_1::tree::param), [`value`](crate::v2_1::tree::value),
//! [`leaf`](crate::v2_1::tree::leaf)). It knows nothing about what a property *means*.
...
//! [`decode`](crate::v2_1::tree::decode) / [`encode`](crate::v2_1::tree::encode) siblings.

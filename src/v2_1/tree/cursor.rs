...
//! [`NCursor`](crate::v2_1::tree::prop::n::NCursor) and
//! [`AdrCursor`](crate::v2_1::tree::prop::adr::AdrCursor) name `N`'s and `ADR`'s
//! components.

use alloc::{borrow::Cow, string::ToString, vec, vec::Vec};

use crate::v2_1::tree::{encode::escape, leaf::VcardLeaf, line::VcardLine, param::VcardParamLens};

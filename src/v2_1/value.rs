...
//! syntactic [`VcardValueNode`](crate::v2_1::tree::value::VcardValueNode)). Most
...
//! [`VcardProp::name`](crate::v2_1::prop::VcardProp::name), and the escaping and
//! framing live on the syntax side ([`crate::v2_1::tree`]). That keeps the whole
...
/// [`VcardProp::name`](crate::v2_1::prop::VcardProp::name).

//! # Value cursor
//!
//! The generic in-place edit cursor used by every scalar, list, URI and binary
//! property lens.
//!
...
//! component-level access for the structured kinds; the bespoke cursors
//! ([`NCursor`](crate::v3_0::tree::prop::n::NCursor),
//! [`AdrCursor`](crate::v3_0::tree::prop::adr::AdrCursor),
//! [`GeoCursor`](crate::v3_0::tree::prop::geo::GeoCursor)) name their components.

use alloc::{borrow::Cow, vec::Vec};

use crate::v3_0::tree::{line::VcardLine, param::VcardParamLens};

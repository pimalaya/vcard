...
//! nodes in the sibling modules ([`line`](crate::v3_0::tree::line),
//! [`param`](crate::v3_0::tree::param), [`value`](crate::v3_0::tree::value),
//! [`leaf`](crate::v3_0::tree::leaf)). It knows nothing about what a property *means*.
...
impl<'a> VcardCst<'a> {
    /// Start an empty vCard 3.0, BEGIN/VERSION/END seeded, ready for properties.
    pub fn v3() -> Self {
        Self {
            begin: VcardLine::text(VCARD_BEGIN, VCARD),
            version: VcardLine::text(VCARD_VERSION, VCARD_VERSION_30),
            props: Vec::new(),
...
mod tests {
    ...
    fn pushes_a_typed_property_onto_a_parsed_card() {
        ...
        assert!(out.contains("N;LANGUAGE=en:Doe;John;;Dr.;\r\n"), "{out}");
    ...
    fn decodes_the_whole_card() {
        ...
        assert_eq!(n.name, "N");
        assert_eq!(n.params, vec![VcardParam::Language(Cow::Borrowed("en"))]);

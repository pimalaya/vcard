...
//! remaining input for [`VcardCst::parse`](crate::v3_0::tree::cst::VcardCst::parse),
...
//! [`decode`](crate::v3_0::tree::decode) / [`encode`](crate::v3_0::tree::encode) bridges.
//!
...
mod tests {
    ...
    use crate::v3_0::tree::line::VcardLine;

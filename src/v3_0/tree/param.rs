...
//! [`VcardParam`](crate::v3_0::param::VcardParam): a name leaf and its raw value
//! leaves, parsed from and serialized back to the wire verbatim. Each RFC 2426
...
//! [`VcardLine::param`](crate::v3_0::tree::line::VcardLine::param). The name dispatch
//! for whole-line decoding lives in [`crate::v3_0::tree::decode`].
...
/// [`VcardParam`](crate::v3_0::param::VcardParam).
#[derive(Clone, Debug)]

...
//!
//! Backs the RFC 2426 properties whose value is a URI: `SOURCE` and `URL`. The
//! reference is kept verbatim as a string; the crate does not parse or validate
//! it. Pure data with no escaping knowledge, like every other type in
//! [`crate::v3_0::value`]; the owning property's wire name lives on
//! [`crate::v3_0::prop::VcardProp::name`].

...
//! nodes in the sibling modules ([`line`](crate::v21::tree::line),
//! [`param`](crate::v21::tree::param), [`value`](crate::v21::tree::value),
//! [`leaf`](crate::v21::tree::leaf)). It knows nothing about what a property *means*.
...
//! [`decode`](crate::v21::tree::decode) / [`encode`](crate::v21::tree::encode) siblings.
...
mod tests {
    ...
    fn decodes_the_whole_card() {
        ...
        assert_eq!(vcard.version, VcardVersion::V21);

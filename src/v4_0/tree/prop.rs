...
//! [`VcardCst::prop`](crate::v4_0::tree::cst::VcardCst::prop). Scalar, list and URI
//! properties share the generic
//! [`VcardValueCursor`](crate::v4_0::tree::cursor::VcardValueCursor); the structured
...
use crate::v4_0::tree::{line::VcardLine, value::VcardValueNode};

...
//! remaining input for [`VcardCst::parse`](crate::v4_0::tree::cst::VcardCst::parse),
...
//! [`decode`](crate::v4_0::tree::decode) / [`encode`](crate::v4_0::tree::encode) bridges.
//!
...
mod tests {
    ...
    use crate::v4_0::tree::line::VcardLine;

...
//! nodes in the sibling modules ([`line`](crate::v4_0::tree::line),
//! [`param`](crate::v4_0::tree::param), [`value`](crate::v4_0::tree::value),
//! [`leaf`](crate::v4_0::tree::leaf)). It knows nothing about what a property *means*.
...
//! [`decode`](crate::v4_0::tree::decode) / [`encode`](crate::v4_0::tree::encode) siblings.

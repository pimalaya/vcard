...
//! [`VcardParam`](crate::v4_0::param::VcardParam): a name leaf and its raw value
...
//! [`VcardLine::param`](crate::v4_0::tree::line::VcardLine::param). The name dispatch
//! for whole-line decoding lives in [`crate::v4_0::tree::decode`].
...
use crate::v4_0::tree::leaf::VcardLeaf;
...
/// [`VcardParam`](crate::v4_0::param::VcardParam).
#[derive(Clone, Debug)]

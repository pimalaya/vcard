...
//! (the syntactic [`VcardValueNode`](crate::v4_0::tree::value::VcardValueNode)). Most
...
//! [`VcardProp::name`](crate::v4_0::prop::VcardProp::name), and the escaping and
//! framing live on the syntax side ([`crate::v4_0::tree`]). That keeps the whole
...
/// property name lives on [`VcardProp::name`](crate::v4_0::prop::VcardProp::name).

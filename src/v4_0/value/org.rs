...
//!
//! `ORG` is a structured RFC 6350 value: a `;`-ordered sequence of organization
...
//! framing and escaping live on the syntax side ([`crate::v4_0::tree`]). The wire name
//! lives on [`crate::v4_0::prop::VcardProp::name`].

...
//! (the syntactic [`VcardValueNode`](crate::v40::tree::value::VcardValueNode)). Most
...
//! [`VcardProp::name`](crate::v40::prop::VcardProp::name), and the escaping and
//! framing live on the syntax side ([`crate::v40::tree`]). That keeps the whole
...
/// property name lives on [`VcardProp::name`](crate::v40::prop::VcardProp::name).

...
//! [`VcardCst::prop`](crate::v40::tree::cst::VcardCst::prop). Scalar, list and URI
//! properties share the generic
//! [`VcardValueCursor`](crate::v40::tree::cursor::VcardValueCursor); the structured
...
use crate::v40::tree::{line::VcardLine, value::VcardValueNode};

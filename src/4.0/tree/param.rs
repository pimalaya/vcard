...
//! [`VcardParam`](crate::v40::param::VcardParam): a name leaf and its raw value
...
//! [`VcardLine::param`](crate::v40::tree::line::VcardLine::param). The name dispatch
//! for whole-line decoding lives in [`crate::v40::tree::decode`].
...
/// [`VcardParam`](crate::v40::param::VcardParam).
#[derive(Clone, Debug)]

...
//! (the syntactic [`VcardValueNode`](crate::v30::tree::value::VcardValueNode)).
...
//! [`VcardProp::name`](crate::v30::prop::VcardProp::name), and the escaping and
//! framing live on the syntax side ([`crate::v30::tree`]). That keeps the whole
...
/// property name lives on [`VcardProp::name`](crate::v30::prop::VcardProp::name).

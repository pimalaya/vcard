...
//! [`VcardParam`](crate::v30::param::VcardParam): a name leaf and its raw value
...
//! [`VcardLine::param`](crate::v30::tree::line::VcardLine::param). The name dispatch
//! for whole-line decoding lives in [`crate::v30::tree::decode`].
...
/// [`VcardParam`](crate::v30::param::VcardParam).
#[derive(Clone, Debug)]

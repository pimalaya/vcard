...
//! [`VcardCst::prop`](crate::v30::tree::cst::VcardCst::prop). Scalar, list, URI
//! and binary properties share the generic
//! [`VcardValueCursor`](crate::v30::tree::cursor::VcardValueCursor); the structured
//! ones (`N`, `ADR`, `GEO`) carry a cursor that names their components. The name
//! dispatch for whole-card decoding lives in [`crate::v30::tree::decode`].
...
use crate::v30::tree::{line::VcardLine, value::VcardValueNode};

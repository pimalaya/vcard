...
//! remaining input for [`VcardCst::parse`](crate::v30::tree::cst::VcardCst::parse),
//! unfolding any RFC 2426 folded continuation lines) and the head splitter that
...
//! [`decode`](crate::v30::tree::decode) / [`encode`](crate::v30::tree::encode) bridges.
//!
...
use crate::v30::tree::{param::VcardParamLens, param::VcardParamNode, value::VcardValueNode};
...
impl<'a> VcardLine<'a> {
    ...
    /// continuation lines, and return it with the remaining input. RFC 2426
...
mod tests {
    ...
    use crate::v30::tree::line::VcardLine;

...
//! `CATEGORIES` for [`VcardTextList`]. They are pure, always-unescaped data;
//! the escaping and the wire framing live entirely on the syntax side
...
//! carried by [`crate::prop::VcardProp::name`], not here.
